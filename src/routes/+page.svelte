  ...
  <div class="main">
      ...
      <div class="card-container">
        <div class="card">
          <div class="card-content">
            ...
            <p>
              Have real-time conversations with the a powerfull AI assistant
              that is trained to not only answer your questions but also make
        ...
        <ul class="ml-2">
          ...
          <li>
            <p>
              A massive thank you to our dedicated <a
                class="link link-hover"
                href="https://pd-enterprise.pages.dev/our-team"
                >Grade App team!</a
          ...
          <li>
            <p>
              ...
              > for their incredible design talent, including the creation of our
              beautiful logo.
            </p>
          </li>
        </ul>
    ...
    <div class="contact mb-5" id="contact">
      ...
      <div class="content ml-2">
        ...
        <a
          href="mailto:gradeappbyapp@gmail.com"
          class="btn btn-primary mt-2 ml-5">Email Us</a
        >
      </div>
    </div>
    <hr />
